      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li ><a href="index.jsp"><font color="white"><b>主页</b></font></a></li>
            <li class ="dropdown" > 
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="active" ><a href="login.jsp"><font color="white"><b>登陆</b></font></a></li>
          ...
          %>
           <ul class="nav navbar-nav navbar-right">
            <li></li>
            <li class="active"><a href="#"><font color="white"><b><em><%=username  %></em></b></font></a></li>
            <li><a href="logout.jsp"><font color="white"><b>注销</font></a></li>
